<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CPeminjamanSiswa.aspx.cs" Inherits="STEPNONE.CPeminjamanSiswa" %>
...
<head runat="server">
    ...
    <style type="text/css">
        ...
        body {
            background-image: linear-gradient(135deg, white, darkgray, lightblue);
            height: 100vh;
        }
        .auto-style4 {
            width: 137px;
