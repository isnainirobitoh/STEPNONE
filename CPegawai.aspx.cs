...
namespace STEPNONE
{
    public partial class CPegawai : System.Web.UI.Page
    {
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            {
                PerpusConnect.Open();
                string insert = "INSERT INTO [Pegawai] (username,password,nama,nohp,alamat) VALUES(@username,@password,@nama,@nohp,@alamat)";
