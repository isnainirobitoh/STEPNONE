<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CPegawai.aspx.cs" Inherits="STEPNONE.CPegawai" %>
...
<body>
    <form id="form1" runat="server">
        <h1 style="text-align: center; font-family: 'Cooper Black'">TAMBAH DATA PEGAWAI</h1>
        <div>
            <br />
            <br />
            <br />
